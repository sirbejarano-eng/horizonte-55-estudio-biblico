...
const translations = {
  es: {
    ...
    offlineReady: 'Disponible sin conexión', offlineNotReady: 'Aún no disponible sin conexión en este idioma', offlineChecking: 'Comprobando disponibilidad sin conexión…', offlineRequiresHttps: 'El modo sin conexión requiere una conexión HTTPS segura en este dispositivo.', offlineUnsupported: 'Este navegador no permite preparar el modo sin conexión.', offlineUnavailable: 'No se pudo preparar el modo sin conexión en este dispositivo.',
  ...
  en: {
    ...
    offlineReady: 'Available offline', offlineNotReady: 'Not yet available offline in this language', offlineChecking: 'Checking offline availability…', offlineRequiresHttps: 'Offline mode requires a secure HTTPS connection on this device.', offlineUnsupported: 'This browser cannot prepare offline mode.', offlineUnavailable: 'Offline mode could not be prepared on this device.',
  ...
  de: {
    ...
    offlineReady: 'Offline verfügbar', offlineNotReady: 'In dieser Sprache noch nicht offline verfügbar', offlineChecking: 'Offline-Verfügbarkeit wird geprüft…', offlineRequiresHttps: 'Der Offline-Modus benötigt auf diesem Gerät eine sichere HTTPS-Verbindung.', offlineUnsupported: 'Dieser Browser kann den Offline-Modus nicht vorbereiten.', offlineUnavailable: 'Der Offline-Modus konnte auf diesem Gerät nicht vorbereitet werden.',
